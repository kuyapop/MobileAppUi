...
public class MapBox : MonoBehaviour
{
    ...
    public float centerLatitude = 14.6572f;
    public float centerLongitude = 120.9941f;
    public float zoom = 12.32f;
    ...
    private float centerLatitudeLast = 14.6572f;
    private float centerLongitudeLast = 120.9941f;
    private float zoomLast = 12.32f;
